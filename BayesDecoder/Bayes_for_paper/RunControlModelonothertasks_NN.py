from get_data_for_decoding import LoadData
from get_data_for_decoding import SVM
from get_data_for_decoding import CommonFunctions
...
class LapWiseAnalysis(object):
    ...
    def fit_classifier_withreference(classifier_type, savedmodel, taskdict, reftask='Task1'):
        ...
        xtrain, xtest, ytrain, ytest = train_test_split(x, y, test_size=0.3, random_state=None,
                                                        shuffle=False)
        referencemodel = SVM.fit_SVM(xtrain, ytrain, classifier_type=classifier_type)
        # referencemodel = savedmodel['Task1']['SVMmodel']
